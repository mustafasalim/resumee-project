...
function EducationAndWork() {
  ...
  return (
   ...
   <div className="w-[400px]  grid gap-2 ml-8 ">
      <div className="text-[20px] font-bold text-blue-500">work experience</div>
                    ...
                    {(subFields, subOpt) => (
                      <div style={{ display: 'flex', flexDirection: 'column', rowGap: 16 }}>
                        ...
                        <Button type="dashed" onClick={() => {
                          subOpt.add()
                        }} block disabled={subFields.length > 0}>
                          + Add work date
                        </Button>
                      </div>
                    )}
        ...
        {(fields, { add, remove }) => (
          <div style={{ display: 'flex', rowGap: 16, flexDirection: 'column' }}>
            {fields.map((field) => (
              ...
              >
                <Form.Item label="academy" name={[field.name, 'name']}>
                  <Input/>
                </Form.Item>
                  ...
                  <Form.List name={[field.name, 'list']}>
                    {(subFields, subOpt) => (
                      <div style={{ display: 'flex', flexDirection: 'column', rowGap: 16 }}>
                        ...
                        <Button type="dashed" onClick={() => subOpt.add()} block disabled={subFields.length > 0}>
                          + Add education
                        </Button>
                      </div>
                    )}
