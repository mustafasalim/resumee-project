import { Input, DatePicker, Form, InputNumber,Select,Button,message } from "antd"
...
function PersonelInformations() {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center  justify-between ml-8 mr-[335px]">
        ...
        <div className="grid gap-2 mt-2">
          ...
          >
            <InputNumber placeholder="05543754****" className=" w-[500px]" />
          </Form.Item>
        </div>
      </div>
    ...
    className="w-[800px]"
      ...
      >
        <Input.TextArea placeholder="Distinctio Et non quas amet mollitia illo accusamus ut" className="h-[110px]" showCount maxLength={100} />
      </Form.Item>
    </div>
